...
function Widget() {
  ...
  const greeting = profile.data?.greeting ?? "Northline here — LED, audio, and labor for live events in New York. What date are you holding?";
      ...
      <div className="fixed right-4 bottom-4 z-20 w-[min(22rem,calc(100vw-2rem))]">
        {open && (
          <div className="mb-2 overflow-hidden rounded-xl bg-card shadow-[var(--shadow-border)]">
            <div className="border-b border-border px-3 py-2 text-sm font-medium">Northline</div>
