...
function SandboxPage() {
  ...
  return (
    <div className="pb-12">
      ...
      />
      <div className="mx-4 mb-6 flex items-start gap-3 rounded-xl bg-card p-4 shadow-[var(--shadow-border)] sm:mx-6">
        <FlaskConical className="mt-0.5 size-4 shrink-0 text-steel" />
        <p className="text-sm text-muted-foreground">
          Sandbox never touches live deals, mail, or production agreements. Promote copies the object into the
          workspace under Ultimate caps (500 fields, 500 automations).
        </p>
      </div>
