...
const PAGES = [
  ...
  { label: "Mail", to: "/mail" },
  { label: "Sending domain", to: "/settings?tab=domain" },
  { label: "Documents", to: "/documents" },
  { label: "Automations", to: "/settings?tab=automations" },
  { label: "Sequences", to: "/settings?tab=sequences" },
  { label: "Live inbox", to: "/inbox" },
  { label: "LeadBooster", to: "/leads?tab=booster" },
  { label: "Chatbot", to: "/chatbot" },
  { label: "Forms", to: "/forms" },
  { label: "Prospector", to: "/prospector" },
  { label: "Scheduler", to: "/scheduler" },
  { label: "Google Meet", to: "/settings?tab=integrations" },
  ...
  { label: "Developers", to: "/settings?tab=api" },
  { label: "Integrations", to: "/settings?tab=integrations" },
  ...
  { label: "Portal domain", to: "/settings?tab=portal" },
  { label: "Client portal", to: "/client-portal" },
  { label: "SMTP", to: "/settings?tab=smtp" },
