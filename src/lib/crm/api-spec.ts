export const API_SCOPES = [
  { id: "events:read", label: "Read events", hint: "Shows, holds, and event dates" },
  { id: "events:write", label: "Write events", hint: "Create and update shows" },
  { id: "clients:read", label: "Read clients", hint: "Organizations and people" },
  { id: "clients:write", label: "Write clients", hint: "Create orgs and contacts" },
  { id: "deals:read", label: "Read deals", hint: "Pipeline records" },
  { id: "deals:write", label: "Write deals", hint: "Create, move, win, lose" },
  { id: "people:read", label: "Read people", hint: "Contact book" },
  { id: "activities:read", label: "Read activities", hint: "Calls, walks, load-ins" },
  { id: "webhooks", label: "Webhooks", hint: "Subscribe and replay" },
] as const;

export type ScopeId = (typeof API_SCOPES)[number]["id"];
...
export const WEBHOOK_EVENTS = [
  ...
  },
  {
    ...
    payload: {
      ...
      data: { id: 1, title: "Citadel holiday", stage: "Negotiation", value: 186400 },
    },
  },
  {
    event: "deal.won",
    ...
    payload: {
      ...
      data: { id: 4, title: "1 Hotel Brooklyn Bridge wedding", value: 28500, status: "won" },
    },
  },
  {
    event: "deal.lost",
  ...
  },
  {
    ...
    payload: {
      ...
      data: { id: 16, name: "The Shed", city: "Manhattan", industry: "Venue" },
    },
  },
  {
    ...
    payload: {
      ...
      data: { id: 40, name: "Amina Cole", email: "amina.cole@nike.com", org: "Nike" },
    },
  },
  {
    ...
    payload: {
      ...
      data: { id: 80, type: "site-survey", subject: "Cipriani walk", due_at: "2026-09-23T14:00:00.000Z" },
    },
  },
  {
    ...
    payload: {
      ...
      data: { guest: "Elena Voss", starts_at: "2026-09-23T15:00:00.000Z", zoom: "https://northline.zoom.us/j/818…" },
    },
  },
  {
    ...
    payload: {
      ...
      data: { form: "show-intake", name: "Maya Chen", venue: "Cipriani 42nd", source: "embed" },
    },
  },
] as const;
...
export const AUTH_EXAMPLE = `Authorization: Bearer nl_live_••••
X-Api-Key: nl_live_••••`;

export const CURL_EXAMPLE = `curl https://app.northline.av/api/v1/events \\
