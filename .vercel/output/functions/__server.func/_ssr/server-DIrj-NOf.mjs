...
import { a as otpCode, i as isStaff, n as emailAllowed, o as provisionProfile, r as hashSha, s as writeAudit, t as effectiveTenantId } from "./access-_g--lJdT.mjs";
import { t as createServerRpc } from "./createServerRpc-CcvdN_gc.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/server-DIrj-NOf.js
function toB64(text) {
...
var resetPasswordWithOtp = createServerFn({ method: "POST" }).validator((input) => input).handler(resetPasswordWithOtp_createServerFn_handler, async ({ data }) => {
	...
	try {
		const { auth } = await import("./server-ByoeSMXP.mjs").then((n) => n.r);
