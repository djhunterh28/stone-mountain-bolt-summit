...
import { A as getPublicWidget, U as widgetAsk, ct as Input, lt as Button, n as Route$3 } from "./router-o_A6MRMh.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/w._slug-543eAYyN.js
...
function Widget() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			(profile.data?.held ?? []).length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "mb-4 max-w-sm text-xs text-muted-foreground",
				children: ["Live holds: ", profile.data?.held.join(" · ")]
			}),
