...
import { d as iso, f as money, n as cn, t as authMiddleware, u as getSql } from "./utils-DLVA4J7b.mjs";
import { t as createSsrRpc } from "./createSsrRpc-B2Izd0c7.mjs";
import { S as unlockSession, b as testSignIn, m as lockSession, s as getAccessState } from "./governance-rJzhZAi0.mjs";
import { n as create, t as persist } from "../_libs/zustand.mjs";
import { L as string, N as number, P as object, R as union, j as literal } from "../_libs/@better-auth/core+[...].mjs";
import { i as signOut, t as authClient } from "./client-B40BzJxt.mjs";
import { i as hasGateSessionMarker, t as auth$1 } from "./server-ByoeSMXP.mjs";
import { a as WEBHOOK_EVENTS, i as REST_ENDPOINTS } from "./api-spec-BdrGwzd_.mjs";
import { t as runAi } from "./ai-Ceoa2a3r.mjs";
import { r as hashSha } from "./access-_g--lJdT.mjs";
import { A as Monitor, B as Kanban, C as Radar, D as PenLine, H as House, I as Mail, J as FlaskConical, L as LayoutGrid, M as Menu, N as Megaphone, P as Map$1, S as Receipt, T as Plus, U as HeartPulse, V as Inbox, W as Handshake, X as FileText, _ as Sparkles, a as Users, b as Search, c as Upload, ct as Check, dt as Briefcase, et as Compass, f as Target, ft as Box, g as SquareCheckBig, h as Star, ht as Bell, i as Wallet, j as MessageSquare, k as Moon, l as Truck, lt as ChartColumn, m as Store, mt as Bookmark, n as X, nt as ClipboardCheck, o as UserPlus, p as Sun, pt as Bot, q as FolderOpen, r as Workflow, rt as CircleUser, s as UserCheck, st as ChevronDown, t as Zap, u as TriangleAlert, ut as Calendar, v as Shield, vt as Activity, w as Plug, x as RectangleEllipsis, y as Settings, z as KeyRound } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/store-BW-TVaH8.js
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bkw81Fhc.js
...
var sendChat = createServerFn({ method: "POST" }).validator((input) => input).handler(createSsrRpc("ea3b1c7a65066ea4a8f655fbd3dde340da3ac64b2dc384ccc045a5444ee79349"));
...
function isPublic(pathname) {
	return pathname.startsWith("/f/") || pathname.startsWith("/book/") || pathname.startsWith("/sign/") || pathname.startsWith("/p/") || pathname.startsWith("/board/") || pathname.startsWith("/w/") || pathname.startsWith("/rsvp/") || pathname.startsWith("/discover") || pathname.startsWith("/cal/") || pathname === "/login" || pathname === "/forgot" || pathname === "/reset" || pathname === "/lookup" || pathname === "/contact" || pathname === "/request";
}
...
var styles_default = "/assets/styles-CZYY_7MT.css";
var APP_NAME = "Northline";
var Route$71 = createRootRoute({
	head: () => ({
		meta: [
			{ charSet: "utf-8" },
			{
...
var $$splitComponentImporter$66 = () => import("./routes-D3XEj4Od.mjs");
...
var $$splitComponentImporter$65 = () => import("./activities-CS7Q9_sZ.mjs");
var Route$69 = createFileRoute("/activities")({ component: lazyRouteComponent($$splitComponentImporter$65, "component") });
var $$splitComponentImporter$64 = () => import("./admin-Cj4LuYf9.mjs");
var Route$68 = createFileRoute("/admin")({ component: lazyRouteComponent($$splitComponentImporter$64, "component") });
var $$splitComponentImporter$63 = () => import("./ai-DMdz7yTj.mjs");
var Route$67 = createFileRoute("/ai")({ component: lazyRouteComponent($$splitComponentImporter$63, "component") });
var $$splitComponentImporter$62 = () => import("./approvals-BYB-1DH4.mjs");
var Route$66 = createFileRoute("/approvals")({ component: lazyRouteComponent($$splitComponentImporter$62, "component") });
var $$splitComponentImporter$61 = () => import("./automations-ChuUAYWp.mjs");
var Route$65 = createFileRoute("/automations")({ component: lazyRouteComponent($$splitComponentImporter$61, "component") });
var $$splitComponentImporter$60 = () => import("./boards-DmwbqMa2.mjs");
var Route$64 = createFileRoute("/boards")({ component: lazyRouteComponent($$splitComponentImporter$60, "component") });
var $$splitComponentImporter$59 = () => import("./bookmarks-BPqe9pTj.mjs");
var Route$63 = createFileRoute("/bookmarks")({ component: lazyRouteComponent($$splitComponentImporter$59, "component") });
var $$splitComponentImporter$58 = () => import("./broadcasts-BwlUf2L-.mjs");
var Route$62 = createFileRoute("/broadcasts")({ component: lazyRouteComponent($$splitComponentImporter$58, "component") });
var $$splitComponentImporter$57 = () => import("./chatbot-CueFEfML.mjs");
var Route$61 = createFileRoute("/chatbot")({ component: lazyRouteComponent($$splitComponentImporter$57, "component") });
var $$splitComponentImporter$56 = () => import("./contact-BIscHKFA.mjs");
var Route$60 = createFileRoute("/contact")({ component: lazyRouteComponent($$splitComponentImporter$56, "component") });
var $$splitComponentImporter$55 = () => import("./contacts-Bz_vrh4_.mjs");
var Route$59 = createFileRoute("/contacts")({ component: lazyRouteComponent($$splitComponentImporter$55, "component") });
var $$splitComponentImporter$54 = () => import("./crew-nWYUrP_-.mjs");
var Route$58 = createFileRoute("/crew")({ component: lazyRouteComponent($$splitComponentImporter$54, "component") });
var $$splitComponentImporter$53 = () => import("./developers-HR_7UWPp.mjs");
var Route$57 = createFileRoute("/developers")({ component: lazyRouteComponent($$splitComponentImporter$53, "component") });
var $$splitComponentImporter$52 = () => import("./discover-BLVXaS8B.mjs");
var Route$56 = createFileRoute("/discover")({ component: lazyRouteComponent($$splitComponentImporter$52, "component") });
var $$splitComponentImporter$51 = () => import("./documents-BdFuaTjF.mjs");
var Route$55 = createFileRoute("/documents")({ component: lazyRouteComponent($$splitComponentImporter$51, "component") });
var $$splitComponentImporter$50 = () => import("./esign-B5IEO2o-.mjs");
var Route$54 = createFileRoute("/esign")({ component: lazyRouteComponent($$splitComponentImporter$50, "component") });
var $$splitComponentImporter$49 = () => import("./files-DCvSiMgz.mjs");
var Route$53 = createFileRoute("/files")({ component: lazyRouteComponent($$splitComponentImporter$49, "component") });
var $$splitComponentImporter$48 = () => import("./finance-CjYK0faH.mjs");
var Route$52 = createFileRoute("/finance")({ component: lazyRouteComponent($$splitComponentImporter$48, "component") });
var $$splitComponentImporter$47 = () => import("./floorplans-BknrIOui.mjs");
var Route$51 = createFileRoute("/floorplans")({ component: lazyRouteComponent($$splitComponentImporter$47, "component") });
var $$splitComponentImporter$46 = () => import("./forecast-CiVK9DEh.mjs");
var Route$50 = createFileRoute("/forecast")({ component: lazyRouteComponent($$splitComponentImporter$46, "component") });
var $$splitComponentImporter$45 = () => import("./forgot-DLjw9gts.mjs");
var Route$49 = createFileRoute("/forgot")({ component: lazyRouteComponent($$splitComponentImporter$45, "component") });
var $$splitComponentImporter$44 = () => import("./forms-Dwss86kz.mjs");
var Route$48 = createFileRoute("/forms")({ component: lazyRouteComponent($$splitComponentImporter$44, "component") });
var $$splitComponentImporter$43 = () => import("./gigs-Crk0yG3r.mjs");
var Route$47 = createFileRoute("/gigs")({ component: lazyRouteComponent($$splitComponentImporter$43, "component") });
var $$splitComponentImporter$42 = () => import("./goals-kTEZSBy6.mjs");
var Route$46 = createFileRoute("/goals")({ component: lazyRouteComponent($$splitComponentImporter$42, "component") });
var $$splitComponentImporter$41 = () => import("./guests-C8Q-Ag10.mjs");
var Route$45 = createFileRoute("/guests")({ component: lazyRouteComponent($$splitComponentImporter$41, "component") });
var $$splitComponentImporter$40 = () => import("./handoff-BPs4XeLO.mjs");
var Route$44 = createFileRoute("/handoff")({ component: lazyRouteComponent($$splitComponentImporter$40, "component") });
var $$splitComponentImporter$39 = () => import("./health-7errbsCB.mjs");
var Route$43 = createFileRoute("/health")({ component: lazyRouteComponent($$splitComponentImporter$39, "component") });
var $$splitComponentImporter$38 = () => import("./home-rRKbPKE4.mjs");
var Route$42 = createFileRoute("/home")({ component: lazyRouteComponent($$splitComponentImporter$38, "component") });
var $$splitComponentImporter$37 = () => import("./import-DrrVmdqy.mjs");
var Route$41 = createFileRoute("/import")({ component: lazyRouteComponent($$splitComponentImporter$37, "component") });
var $$splitComponentImporter$36 = () => import("./inbox-DqprPMcd.mjs");
var Route$40 = createFileRoute("/inbox")({ component: lazyRouteComponent($$splitComponentImporter$36, "component") });
var $$splitComponentImporter$35 = () => import("./insights-Dvr2OtaS.mjs");
var Route$39 = createFileRoute("/insights")({ component: lazyRouteComponent($$splitComponentImporter$35, "component") });
var $$splitComponentImporter$34 = () => import("./integrations-DqUdvEzo.mjs");
var Route$38 = createFileRoute("/integrations")({ component: lazyRouteComponent($$splitComponentImporter$34, "component") });
var $$splitComponentImporter$33 = () => import("./leadbooster-DcVWj-si.mjs");
var Route$37 = createFileRoute("/leadbooster")({ component: lazyRouteComponent($$splitComponentImporter$33, "component") });
var $$splitComponentImporter$32 = () => import("./leads-gQDWxxV3.mjs");
var Route$36 = createFileRoute("/leads")({ component: lazyRouteComponent($$splitComponentImporter$32, "component") });
var $$splitComponentImporter$31 = () => import("./login-B44mP3Sm.mjs");
var Route$35 = createFileRoute("/login")({ component: lazyRouteComponent($$splitComponentImporter$31, "component") });
var $$splitComponentImporter$30 = () => import("./lookup-CSA6LKce.mjs");
var Route$34 = createFileRoute("/lookup")({ component: lazyRouteComponent($$splitComponentImporter$30, "component") });
var $$splitComponentImporter$29 = () => import("./mail-Ce4g1c4h.mjs");
var Route$33 = createFileRoute("/mail")({ component: lazyRouteComponent($$splitComponentImporter$29, "component") });
var $$splitComponentImporter$28 = () => import("./marketplace-CbBzsS9d.mjs");
var Route$32 = createFileRoute("/marketplace")({ component: lazyRouteComponent($$splitComponentImporter$28, "component") });
var $$splitComponentImporter$27 = () => import("./products-DfrwKpvT.mjs");
var Route$31 = createFileRoute("/products")({ component: lazyRouteComponent($$splitComponentImporter$27, "component") });
var $$splitComponentImporter$26 = () => import("./profile-Bv7TxPrb.mjs");
var Route$30 = createFileRoute("/profile")({ component: lazyRouteComponent($$splitComponentImporter$26, "component") });
var $$splitComponentImporter$25 = () => import("./projects-mPiTpC0p.mjs");
var Route$29 = createFileRoute("/projects")({ component: lazyRouteComponent($$splitComponentImporter$25, "component") });
var $$splitComponentImporter$24 = () => import("./proposals-Bfo7Nhsw.mjs");
var Route$28 = createFileRoute("/proposals")({ component: lazyRouteComponent($$splitComponentImporter$24, "component") });
var $$splitComponentImporter$23 = () => import("./prospector-CBQC7JeZ.mjs");
var Route$27 = createFileRoute("/prospector")({ component: lazyRouteComponent($$splitComponentImporter$23, "component") });
var $$splitComponentImporter$22 = () => import("./pulse-Dz6hQjfP.mjs");
var Route$26 = createFileRoute("/pulse")({ component: lazyRouteComponent($$splitComponentImporter$22, "component") });
var $$splitComponentImporter$21 = () => import("./quotes-BkicIf2n.mjs");
var Route$25 = createFileRoute("/quotes")({ component: lazyRouteComponent($$splitComponentImporter$21, "component") });
var $$splitComponentImporter$20 = () => import("./request-CCCOboe9.mjs");
var Route$24 = createFileRoute("/request")({ component: lazyRouteComponent($$splitComponentImporter$20, "component") });
var $$splitComponentImporter$19 = () => import("./reviews-Dz3oH0hC.mjs");
var Route$23 = createFileRoute("/reviews")({ component: lazyRouteComponent($$splitComponentImporter$19, "component") });
var $$splitComponentImporter$18 = () => import("./sandbox-C2yIBbAW.mjs");
var Route$22 = createFileRoute("/sandbox")({ component: lazyRouteComponent($$splitComponentImporter$18, "component") });
var $$splitComponentImporter$17 = () => import("./scheduler-D-Mvd_Nu.mjs");
var Route$21 = createFileRoute("/scheduler")({ component: lazyRouteComponent($$splitComponentImporter$17, "component") });
var $$splitComponentImporter$16 = () => import("./security-CQM3kmWE.mjs");
var Route$20 = createFileRoute("/security")({ component: lazyRouteComponent($$splitComponentImporter$16, "component") });
var $$splitComponentImporter$15 = () => import("./sequences-C8Ja82Pm.mjs");
var Route$19 = createFileRoute("/sequences")({ component: lazyRouteComponent($$splitComponentImporter$15, "component") });
var $$splitComponentImporter$14 = () => import("./settings-D2QKT4LB.mjs");
var Route$18 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$14, "component") });
var $$splitComponentImporter$13 = () => import("./tasks-BjBmXcyb.mjs");
var Route$17 = createFileRoute("/tasks")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./travel-C8acKTxh.mjs");
var Route$16 = createFileRoute("/travel")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./board._token-Dt-hlf4A.mjs");
var Route$15 = createFileRoute("/board/$token")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./book._slug-wUoSSvWP.mjs");
var Route$14 = createFileRoute("/book/$slug")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
...
var getFloorPlans = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("7459998e01678afda80b4b84e573f67634474012251460cbf2036f72155a877c"));
var saveFloorPlan = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("aa519d1adba77860c00b704c0bef182ecddf9c19345a4a65dcce980794182c42"));
...
var getReviews = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("caad77a72c5411e6b26d1b7650c855d558b29c9bf0ca57b3ffeaad9b9d3961aa"));
var routeReview = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("d7a62694e87bed27ad2b03ecd0b170f3ade626f0f5f8e8229b7ccfa32dc2e38b"));
...
var importCold = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("4fef50a5c319285f231e2eee427b1c76880432fb221adc4071394296c554f776"));
var promoteProspect = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("517d6a6b5d9c36eb5d59474c96b7064b1710b7ba13060070778ca16c11eeebe5"));
var sendSms = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("48ac317c961498652af996df99eb88873d68ab0b7c57ec8863f49ef558c29383"));
...
var getHandoffs = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("bd186e3b3090f29f7d0437aeafa55cb7f2b23ebe495d71beb0592f6060252f13"));
var sendHandoff = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("aa93d49b55388ce31e25a544feb93d0b60200395a863ec7eeac31304cd74adb3"));
...
var getUnifiedInbox = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("0aebdf04a7c92cbe0135b9a2084a87e8bfbe9a1c40189927d23663828d5a1d10"));
...
var Route$13 = createFileRoute("/cal/$token")({ server: { handlers: { GET: async ({ params }) => {
...
var $$splitComponentImporter$9 = () => import("./contacts._personId-DILVlwBm.mjs");
var Route$12 = createFileRoute("/contacts/$personId")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./deals._dealId-I8sUNbf6.mjs");
var Route$11 = createFileRoute("/deals/$dealId")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./esign._envelopeId-BGZGzQA5.mjs");
var Route$10 = createFileRoute("/esign/$envelopeId")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./f._slug-OU7ryDUp.mjs");
var Route$9 = createFileRoute("/f/$slug")({
	validateSearch: (s) => ({
...
var $$splitComponentImporter$5 = () => import("./orgs._orgId-LCUg7FR7.mjs");
var Route$8 = createFileRoute("/orgs/$orgId")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./p._token-Be8d2eKA.mjs");
var Route$7 = createFileRoute("/p/$token")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./projects._projectId-CKWDxbCi.mjs");
var Route$6 = createFileRoute("/projects/$projectId")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./rsvp._token-D6aNMn3c.mjs");
var Route$5 = createFileRoute("/rsvp/$token")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./sign._docId-DZx0Cb1j.mjs");
var Route$4 = createFileRoute("/sign/$docId")({
	component: lazyRouteComponent($$splitComponentImporter$1, "component"),
	validateSearch: (s) => ({ envelope: typeof s.envelope === "string" ? s.envelope : void 0 })
});
var $$splitComponentImporter = () => import("./w._slug-DYcXMsAp.mjs");
...
var ActivitiesRoute = Route$69.update({
	id: "/activities",
	path: "/activities",
	getParentRoute: () => Route$71
});
var AdminRoute = Route$68.update({
	id: "/admin",
	path: "/admin",
	getParentRoute: () => Route$71
});
var AiRoute = Route$67.update({
	id: "/ai",
	path: "/ai",
	getParentRoute: () => Route$71
});
var ApprovalsRoute = Route$66.update({
	id: "/approvals",
	path: "/approvals",
	getParentRoute: () => Route$71
});
var AutomationsRoute = Route$65.update({
	id: "/automations",
	path: "/automations",
	getParentRoute: () => Route$71
});
var BoardsRoute = Route$64.update({
	id: "/boards",
	path: "/boards",
	getParentRoute: () => Route$71
});
var BookmarksRoute = Route$63.update({
	id: "/bookmarks",
	path: "/bookmarks",
	getParentRoute: () => Route$71
});
var BroadcastsRoute = Route$62.update({
	id: "/broadcasts",
	path: "/broadcasts",
	getParentRoute: () => Route$71
});
var ChatbotRoute = Route$61.update({
	id: "/chatbot",
	path: "/chatbot",
	getParentRoute: () => Route$71
});
var ContactRoute = Route$60.update({
	id: "/contact",
	path: "/contact",
	getParentRoute: () => Route$71
});
var ContactsRoute = Route$59.update({
	id: "/contacts",
	path: "/contacts",
	getParentRoute: () => Route$71
});
var CrewRoute = Route$58.update({
	id: "/crew",
	path: "/crew",
	getParentRoute: () => Route$71
});
var DevelopersRoute = Route$57.update({
	id: "/developers",
	path: "/developers",
	getParentRoute: () => Route$71
});
var DiscoverRoute = Route$56.update({
	id: "/discover",
	path: "/discover",
	getParentRoute: () => Route$71
});
var DocumentsRoute = Route$55.update({
	id: "/documents",
	path: "/documents",
	getParentRoute: () => Route$71
});
var EsignRoute = Route$54.update({
	id: "/esign",
	path: "/esign",
	getParentRoute: () => Route$71
});
var FilesRoute = Route$53.update({
	id: "/files",
	path: "/files",
	getParentRoute: () => Route$71
});
var FinanceRoute = Route$52.update({
	id: "/finance",
	path: "/finance",
	getParentRoute: () => Route$71
});
var FloorplansRoute = Route$51.update({
	id: "/floorplans",
	path: "/floorplans",
	getParentRoute: () => Route$71
});
var ForecastRoute = Route$50.update({
	id: "/forecast",
	path: "/forecast",
	getParentRoute: () => Route$71
});
var ForgotRoute = Route$49.update({
	id: "/forgot",
	path: "/forgot",
	getParentRoute: () => Route$71
});
var FormsRoute = Route$48.update({
	id: "/forms",
	path: "/forms",
	getParentRoute: () => Route$71
});
var GigsRoute = Route$47.update({
	id: "/gigs",
	path: "/gigs",
	getParentRoute: () => Route$71
});
var GoalsRoute = Route$46.update({
	id: "/goals",
	path: "/goals",
	getParentRoute: () => Route$71
});
var GuestsRoute = Route$45.update({
	id: "/guests",
	path: "/guests",
	getParentRoute: () => Route$71
});
var HandoffRoute = Route$44.update({
	id: "/handoff",
	path: "/handoff",
	getParentRoute: () => Route$71
});
var HealthRoute = Route$43.update({
	id: "/health",
	path: "/health",
	getParentRoute: () => Route$71
});
var HomeRoute = Route$42.update({
	id: "/home",
	path: "/home",
	getParentRoute: () => Route$71
});
var ImportRoute = Route$41.update({
	id: "/import",
	path: "/import",
	getParentRoute: () => Route$71
});
var InboxRoute = Route$40.update({
	id: "/inbox",
	path: "/inbox",
	getParentRoute: () => Route$71
});
var InsightsRoute = Route$39.update({
	id: "/insights",
	path: "/insights",
	getParentRoute: () => Route$71
});
var IntegrationsRoute = Route$38.update({
	id: "/integrations",
	path: "/integrations",
	getParentRoute: () => Route$71
});
var LeadboosterRoute = Route$37.update({
	id: "/leadbooster",
	path: "/leadbooster",
	getParentRoute: () => Route$71
});
var LeadsRoute = Route$36.update({
	id: "/leads",
	path: "/leads",
	getParentRoute: () => Route$71
});
...
var LookupRoute = Route$34.update({
	id: "/lookup",
	path: "/lookup",
	getParentRoute: () => Route$71
});
var MailRoute = Route$33.update({
	id: "/mail",
	path: "/mail",
	getParentRoute: () => Route$71
});
var MarketplaceRoute = Route$32.update({
	id: "/marketplace",
	path: "/marketplace",
	getParentRoute: () => Route$71
});
var ProductsRoute = Route$31.update({
	id: "/products",
	path: "/products",
	getParentRoute: () => Route$71
});
...
var ProjectsRoute = Route$29.update({
	id: "/projects",
	path: "/projects",
	getParentRoute: () => Route$71
});
var ProposalsRoute = Route$28.update({
	id: "/proposals",
	path: "/proposals",
	getParentRoute: () => Route$71
});
var ProspectorRoute = Route$27.update({
	id: "/prospector",
	path: "/prospector",
	getParentRoute: () => Route$71
});
var PulseRoute = Route$26.update({
	id: "/pulse",
	path: "/pulse",
	getParentRoute: () => Route$71
});
...
var RequestRoute = Route$24.update({
	id: "/request",
	path: "/request",
	getParentRoute: () => Route$71
});
var ReviewsRoute = Route$23.update({
	id: "/reviews",
	path: "/reviews",
	getParentRoute: () => Route$71
});
var SandboxRoute = Route$22.update({
	id: "/sandbox",
	path: "/sandbox",
	getParentRoute: () => Route$71
});
var SchedulerRoute = Route$21.update({
	id: "/scheduler",
	path: "/scheduler",
	getParentRoute: () => Route$71
});
var SecurityRoute = Route$20.update({
	id: "/security",
	path: "/security",
	getParentRoute: () => Route$71
});
var SequencesRoute = Route$19.update({
	id: "/sequences",
	path: "/sequences",
	getParentRoute: () => Route$71
});
var SettingsRoute = Route$18.update({
	id: "/settings",
	path: "/settings",
	getParentRoute: () => Route$71
});
var TasksRoute = Route$17.update({
	id: "/tasks",
	path: "/tasks",
	getParentRoute: () => Route$71
});
var TravelRoute = Route$16.update({
	id: "/travel",
	path: "/travel",
	getParentRoute: () => Route$71
});
var BoardTokenRoute = Route$15.update({
	id: "/board/$token",
	path: "/board/$token",
	getParentRoute: () => Route$71
});
var BookSlugRoute = Route$14.update({
	id: "/book/$slug",
	path: "/book/$slug",
	getParentRoute: () => Route$71
});
var CalTokenRoute = Route$13.update({
	id: "/cal/$token",
	path: "/cal/$token",
	getParentRoute: () => Route$71
});
var ContactsPersonIdRoute = Route$12.update({
	id: "/$personId",
	path: "/$personId",
	getParentRoute: () => ContactsRoute
});
var DealsDealIdRoute = Route$11.update({
	id: "/deals/$dealId",
	path: "/deals/$dealId",
	getParentRoute: () => Route$71
});
var EsignEnvelopeIdRoute = Route$10.update({
	id: "/$envelopeId",
	path: "/$envelopeId",
	getParentRoute: () => EsignRoute
});
var FSlugRoute = Route$9.update({
	id: "/f/$slug",
	path: "/f/$slug",
	getParentRoute: () => Route$71
});
var OrgsOrgIdRoute = Route$8.update({
	id: "/orgs/$orgId",
	path: "/orgs/$orgId",
	getParentRoute: () => Route$71
});
var PTokenRoute = Route$7.update({
	id: "/p/$token",
	path: "/p/$token",
	getParentRoute: () => Route$71
});
var ProjectsProjectIdRoute = Route$6.update({
	id: "/$projectId",
	path: "/$projectId",
	getParentRoute: () => ProjectsRoute
});
var RsvpTokenRoute = Route$5.update({
	id: "/rsvp/$token",
	path: "/rsvp/$token",
	getParentRoute: () => Route$71
});
var SignDocIdRoute = Route$4.update({
	id: "/sign/$docId",
	path: "/sign/$docId",
	getParentRoute: () => Route$71
});
...
//#endregion
export { TabsContent as $, setDealStatus as $n, signEnvelope as $t, getReviews as A, listActivities as An, inviteSubuser as At, saveFloorPlan as B, listProducts as Bn, listProposals as Bt, getGuests as C, exportDealsCsv as Cn, getDashboard as Ct, getPersonPrefs as D, getProject as Dn, getPortalMe as Dt, getOpsHome as E, getInsights as En, getEsignMonitor as Et, pinNote as F, listFields as Fn, listEnvelopes as Ft, submitQuote as G, listSequences as Gn, mutateBookmark as Gt, sendSms as H, listReports as Hn, listTaskLists as Ht, promoteProspect as I, listLeads as In, listEventRequests as It, Route$15 as J, moveDeal as Jn, resetPasswordWithOtp as Jt, widgetAsk as K, listTemplates as Kn, mutateTask as Kt, recordPayment as L, listMarketplace as Ln, listNotifPrefs as Lt, importCold as M, listDeals as Mn, listApprovals as Mt, listEventNotes as N, listDocuments as Nn, listAudit as Nt, getPublicWidget as O, getPulse as On, getPortalProject as Ot, markFinding as P, listEmails as Pn, listBookmarks as Pt, Tabs as Q, sendEmail as Qn, sharePortalFile as Qt, routeReview as R, listOrgs as Rn, listPortalFiles as Rt, getGigs as S, createReport as Sn, getBranding as St, getHealth as T, getDeal as Tn, getEnvelopePublic as Tt, setCommPref as U, listScheduler as Un, listTenants as Ut, sendHandoff as V, listProspects as Vn, listSubusers as Vt, setRsvp as W, listScores as Wn, lookupDocument as Wt, PageHeader as X, resolveAlert as Xn, setNotifPref as Xt, Route$70 as Y, moveTask as Yn, saveBranding as Yt, useCurrentUserState as Z, sendChat as Zn, setTenantQuota as Zt, getBroadcastDesk as _, convertLead as _n, createApproval as _t, Route$6 as a, updateEnvelopeStatus as an, updateDeal as ar, SelectTrigger as at, getFinance as b, createField as bn, decideApproval as bt, Route$9 as c, verifyOtp as cn, THEME_OPTIONS as cr, Label as ct, Route$12 as d, addDealProduct as dn, MemberAvatar as dt, submitContact as en, toggleActivity as er, TabsList as et, addEventNote as f, addFileMeta as fn, addEnvelopeField as ft, getAiDesk as g, bookSlot as gn, convertDealToProject as gt, draftFromDeal as h, advanceDocument as hn, completeOnboardingStep as ht, Route$5 as i, toggleProjectNote as in, toggleSequence as ir, SelectItem as it, getUnifiedInbox as j, listAutomations as jn, issueOtp as jt, getQuotes as k, getSecurity as kn, getProposalPublic as kt, Route$10 as l, zipPortalFiles as ln, THEME_SWATCHES as lr, Input as lt, createStandaloneInvoice as m, addTask as mn, checkEmailGate as mt, Route$3 as n, switchTenant as nn, toggleAutomation as nr, Select as nt, Route$7 as o, updatePortalProfile as on, updateLead as or, SelectValue as ot, awardGig as p, addProspect as pn, addProjectRequest as pt, Route$14 as q, mergePeople as qn, remindEnvelope as qt, Route$4 as r, syncPipedrive as rn, toggleRule as rr, SelectContent as rt, Route$8 as s, uploadPortalFile as sn, updateStage as sr, Textarea as st, router_exports as t, submitEventRequest as tn, toggleApp as tr, TabsTrigger as tt, Route$11 as u, addComment as un, useUi as ur, Button as ut, getCrew as v, createAutomation as vn, createEnvelope as vt, getHandoffs as w, getBootstrap as wn, getEnvelope as wt, getFloorPlans as x, createProduct as xn, downloadPortalFile as xt, getDirectory as y, createDocument as yn, createProposal as yt, saveAiProfile as z, listPeople as zn, listPortalProjects as zt };
