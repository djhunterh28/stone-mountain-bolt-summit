...
import { $t as signEnvelope, Tt as getEnvelopePublic, ct as Label, hn as advanceDocument, lt as Input, r as Route$4, ut as Button } from "./router-Bkw81Fhc.mjs";
import { t as Badge } from "./badge-BQYjLRpy.mjs";
import { s as getDocumentPublic } from "./ultimate-JaIPPjEW.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sign._docId-DZx0Cb1j.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function PublicSign() {
	const { docId } = Route$4.useParams();
	const { envelope } = Route$4.useSearch();
