...
import { J as Route$15 } from "./router-Bkw81Fhc.mjs";
import { n as getBoardPublic } from "./boards-DZSfjon3.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/board._token-Dt-hlf4A.js
...
function KioskBoard() {
	const { token } = Route$15.useParams();
