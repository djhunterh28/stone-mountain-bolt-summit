...
import { i as formatDate, o as formatUsd, s as formatUsdFull, t as cn } from "./utils-BjcRTCQS.mjs";
import { u as require_react } from "../_libs/@floating-ui/react-dom+[...].mjs";
import { b as useNavigate } from "../_libs/@tanstack/react-router+[...].mjs";
import { m as require_jsx_runtime } from "../_libs/@radix-ui/react-checkbox+[...].mjs";
import { $ as GripVertical, H as MapPin, K as LayoutList, ct as Download, dt as Clock, it as Flame, tt as Funnel } from "../_libs/lucide-react.mjs";
import { i as useQueryClient, n as useQuery, t as useMutation } from "../_libs/tanstack__react-query.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { $ as TabsList, Cn as exportDealsCsv, Jn as moveDeal, Mn as listDeals, Z as Tabs, at as SelectValue, ct as Input, et as TabsTrigger, it as SelectTrigger, lt as Button, nt as SelectContent, q as Route$85, rt as SelectItem, tt as Select, ut as MemberAvatar, wn as getBootstrap } from "./router-o_A6MRMh.mjs";
import { t as Badge } from "./badge-D81dvCVi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BCXCv5cI.js
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GripVertical, { className: "mt-0.5 size-3.5 shrink-0 text-muted-foreground" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							deal.eventType && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
								variant: "steel",
								children: deal.eventType
							}),
							deal.status === "cancelled" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
								variant: "warn",
								children: "cancelled"
							}),
							deal.status === "lost" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
								variant: "danger",
								children: "lost"
							})
						]
...
function PipelinePage() {
	const { pipeline: pipelineParam, deal: dealParam } = Route$85.useSearch();
	const navigate = useNavigate({ from: "/" });
	const qc = useQueryClient();
	const [status, setStatus] = (0, import_react.useState)("open");
	const [owner, setOwner] = (0, import_react.useState)("all");
	const [eventType, setEventType] = (0, import_react.useState)("all");
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
							...
							value: "all",
							children: "All types"
						}), (boot.data?.eventTypes ?? []).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							value: t.name,
							children: t.name
						}, t.id))] })]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
						...
						}), Array.from(new Set((deals.data ?? []).map((d) => d.source).filter(Boolean))).map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectItem, {
							value: s,
							children: s
						}, s))] })]
					}),
