...
import { o as GROK_PROVIDERS } from "./server-ByoeSMXP.mjs";
import { Z as useCurrentUserState, cn as verifyOtp, ct as Label, jt as issueOtp, lt as Input, mt as checkEmailGate, ut as Button } from "./router-Bkw81Fhc.mjs";
import { t as Separator } from "./separator-BU1uFMXP.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-B44mP3Sm.js
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Registered access"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
							className: "mt-3 text-4xl font-semibold tracking-tight text-balance",
							children: "The house CRM for live event production."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-4 max-w-sm text-sm leading-relaxed text-muted-foreground",
							children: "Pipeline, labor, and show files stay behind a signed-in session. Public booking, web forms, and e-sign links remain open for clients."
						}),
