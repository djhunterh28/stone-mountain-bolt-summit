...
import { o as formatUsd, s as formatUsdFull } from "./utils-BjcRTCQS.mjs";
...
import { D as getHealth, En as getInsights, Hn as listReports, J as PageHeader, Sn as createReport, ct as Input, lt as Button } from "./router-o_A6MRMh.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/insights-DxSmHSbb.js
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stat, {
						...
						value: `${health.data?.conversion ?? "—"}%`,
						hint: `${health.data?.leadConverted ?? 0} of ${health.data?.leadN ?? 0} leads`
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-3 grid grid-cols-2 gap-3 px-4 sm:grid-cols-4 sm:px-6",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stat, {
						label: "Collected",
						value: health.data ? formatUsdFull(health.data.kpis.collected) : "—",
						hint: health.data ? `of ${formatUsdFull(health.data.kpis.invoiced)} invoiced` : ""
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stat, {
						label: "Abandoned quotes",
						value: String(health.data?.abandoned ?? "—"),
						hint: `${health.data?.quotes ?? 0} quotes total`
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stat, {
						label: "Ghosted",
						value: String(health.data?.ghosted.length ?? "—"),
						hint: "Open > 14 days silent"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Stat, {
						label: "Health flags",
						value: String(health.data?.flags.length ?? "—"),
						hint: "Contract / schedule / $0"
					})
				]
			}),
